        ...
        async with conn.cursor() as cur:
            ...
            if nombre_rol != None:
                if nombre_rol == "Docente":
                    ...
                    usuario = {'id_usuario': result['id_usuario'], 'nombre_usuario': result['nombre_usuario'], 'contrasena_usuario': result['nombre_usuario'], 'rol_usuario': result['rol_usuario'],'id_docente': result['id_docente'],'nombres_docente': result['nombres_docente'],'apellidos_docente': result['apellidos_docente'],'cedula_docente': result['cedula_docente'],'fechaNacimiento_docente': result['fechaNacimiento_docente'],'edad_docente': result['edad_docente'],'direccion_docente': result['direccion_docente'],'telefono_docente': result['telefono_docente'],'email_docente': result['email_docente'],'titulo_docente': result['titulo_docente'],'nivelEducacion_docente': result['nivelEducacion_docente'],'estado_docente': result['estado_docente']}
                    usuarios.append(usuario)
